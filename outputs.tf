...
output "kms_key_arn" {
  ...
  value       = try(module.eks.kms_key_arn, "")
}

output "kms_key_id" {
  description = "The globally unique identifier for the key"
  value       = try(module.eks.kms_key_id, "")
}

output "kms_key_policy" {
  description = "The IAM resource policy set on the key"
  value       = try(module.eks.key_policy, "")
}
...
output "node_security_group_arn" {
  ...
  value       = try(module.eks.node_security_group_arn, "")
}
...
output "cluster_tls_certificate_sha1_fingerprint" {
  ...
  value       = try(module.eks.cluster_tls_certificate_sha1_fingerprint, "")
}
...
output "self_managed_node_groups_autoscaling_group_names" {
  ...
  value       = try(module.eks.self_managed_node_group, "")
}

### KubeCost 

# output "kubecost_alb_hostname" {
#   description = "Hostname for KubeCost load balancer"
#   value       = var.enable_kubecost ? data.kubernetes_ingress_v1.kubecost[0].status.0.load_balancer.0.ingress.0.hostname : ""
# }
